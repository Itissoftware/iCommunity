...
import static software.is.com.myapplication.CommonUtilities.displayMessage;
...
//        Log.e("ddddddd", link);
    ...
    private static void generateNotification(Context context, String message,String type) {
       // Log.e("message",message);
        ...
        Notification notification = new Notification(icon, type, when);
        ...
        try {
            ...
            m.invoke(notification, context, title, message, intent);
        } catch (Exception e) {
            // do nothing
        }
